# Section 1: JavaScript Introduction Game

This section will see you make a fairly simple game. In doing so, you'll use JavaScript to
...
You can see a completed example here: <https://francescmarti00.github.io/dmu-multimedia/resources/JSIntroGame/>
...
Mole: <https://francescmarti00.github.io/dmu-multimedia/resources/JSIntroGame/img/mole.png>
Hedgehog: <https://francescmarti00.github.io/dmu-multimedia/resources/JSIntroGame/img/hedgehog.png>
...
## Add more animals to your game

You can find more images for your game here: <https://www.dreamstime.com/stock-vector-illustrations-clipart>
Download two new animals. For example, a horse and a pinguin.

## Working with probabilities

In the original game, the probability of displaying the mole was 50% and the probability of displaying the hedgehog was 50%. Modify your code to implement the following probabilities:
...
In the original game, the user should get a point if they click on the mole, and lose a point if they click on the hedgehog.
Let's make something a little bit more interesting:

1. If the user click on the mole, add 2 to the score
2. Hedgehog, add 1 to the score
3. Horse, subtract 1
4. Pinguin, subtract 2

## Adding random positions and sizes

In the original game, we have used random numbers to control which animal is displayed. But we can also use random numbers to control other aspects of the game.
herefore:

1. Add three new random number generators to your game.
2. Use one of these random numbers to controls de dimensions of the animal.
3. Use the other two random numbers to control the position of the animal in the screen.

## Changing the game speed

Finally, let's make more interesting the game by modifying its speed. So:

1. If the score is 0 or lower than 0, the game will run at the normal speed.
2. The speed of the game must to increase in in synchronization with the score. So, the higher the score, the fastest the game.
