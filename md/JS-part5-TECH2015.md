...
**Exercise 5**. The following code creates a collapsed sidebar. Run and analyse the following code.
...
**Exercise 6 (Optional)**. <https://www.w3schools.com/howto/default.asp>
